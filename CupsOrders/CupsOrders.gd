...
func new_client():
	...
	cup_button_instance.connect("pressed", self, "_on_cup_button_click", [cup_button_instance, client_instance.gm_name, client_instance.command])
	$CupsQueue.add_child(cup_button_instance)
	
func _on_cup_button_click(cup, gm_name, command):
